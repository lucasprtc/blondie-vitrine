...
const AboutSection = () => {
    ...
    return (
        <section id="about" ref={aboutSectionRef} className="relative grid-container grid-layout overflow-hidden py-6 lg:py-0">
            <div
                ref={squareRef}
                className="z-10 absolute top-[90px] lg:top-[200px] left-1/2 lg:left-0 -translate-x-1/2 lg:translate-none col-span-6 lg:col-start-4 p-4 w-[calc(100%-32px)] lg:w-fit flex flex-row items-center justify-between gap-4 lg:gap-8 bg-white rounded-[10px] shadow-2xl"
            >
            ...
            <div ref={line} className="absolute translate-x-1/2 h-[375px] md:h-[800px] w-px bg-black right-1/2 mt-[140px] lg:mt-[220px]"></div>
